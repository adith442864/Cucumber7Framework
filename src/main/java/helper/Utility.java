...
public class Utility {
	...
	/*
	 * Find the element until its clickable (custom method)and It will highlight as
	 * well
	 */
	...
	public static void captureScreenshot(WebDriver driver) {
		...
		try {
			FileHandler.copy(((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE),
					new File("./screenshot/screenshot" + getCurrentDate() + ".png"));
	...
	/*
	 * 
	 * This method will wait till the time that specified in parameter for alert to
	 * appear
	 * 
	 * @param - WebDriver instance
	 * 
