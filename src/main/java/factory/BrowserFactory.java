...
public class BrowserFactory {
	...
	public static WebDriver startBrowser(String browserName, String applicationURL) {
		...
		driver.manage().timeouts()
				.pageLoadTimeout(Duration.ofSeconds(Integer.parseInt(ConfigReader.getProperty("pageLoad"))));

		driver.manage().timeouts()
				.scriptTimeout(Duration.ofSeconds(Integer.parseInt(ConfigReader.getProperty("scriptTimeOut"))));
